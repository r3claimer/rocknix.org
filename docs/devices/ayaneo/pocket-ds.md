...
# AYANEO Pocket DS (SM8550)

![](../../_inc/images/devices/ayaneo-pocket-ds.png){ .off-glb }

## Overview

| Device                        | CPU / Architecture      | Kernel         | GL driver | Vulkan driver | Interface                |
| ----------------------------- | ----------------------- | -------------- | --------- | ------------- | ------------------------ |
| AYANEO Pocket DS | Qualcomm G3x Gen2 (SM8550) | Mainline Linux | Freedreno | Turnip        | Sway + Emulation Station |
