...
![](../../_inc/images/devices/ayn-odin-3.png){ .off-glb }

## Overview

| Device                        | CPU / Architecture      | Kernel         | GL driver | Vulkan driver | Interface                |
| ----------------------------- | ----------------------- | -------------- | --------- | ------------- | ------------------------ |
| Ayn Odin 3 (Base / Pro / Max / Ultra) | Qualcomm Dragonwing Q8 (SM8750) | Mainline Linux | Freedreno | Turnip | Sway + Emulation Station |
...
- [Platform Documentation (SM8750)](https://github.com/ROCKNIX/distribution/tree/next/documentation/PER_DEVICE_DOCUMENTATION/SM8750)
